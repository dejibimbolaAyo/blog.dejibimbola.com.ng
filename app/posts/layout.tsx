...
const PostLayout: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="container bg-white dark:bg-neutral-900 my-4 p-4 lg:my-16 lg:p-16 mx-auto">
      ...
      <div className="border-b-2 border-gray-200 dark:border-gray-800 mb-8 rounded-full" />
