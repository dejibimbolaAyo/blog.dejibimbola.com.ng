    ...
    <article className="xl:divide-y xl:divide-gray-200">
      ...
      >
          ...
          {meta.discussion && (
            <div className="pt-6 pb-16">
              <p>
                ...
                <a href={meta.discussion} className="font-medium text-yellow-400 hover:text-yellow-500">
        ...
        <footer className="text-sm font-medium leading-5 divide-y divide-gray-200 xl:col-start-1 xl:row-start-2">
          ...
          <div className="pt-8">
            <Link href="/">
              <a className="text-yellow-400 hover:text-yellow-500">&larr; Back to the blog</a>
            </Link>
          </div>
        </footer>
      </div>
